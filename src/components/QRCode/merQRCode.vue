...
export default {
  ...
  methods: {
    ...
    handleClick() {
      ...
      if (this.item.length < 1||this.perName.length < 1||this.name.length < 1||
        this.address1.length < 1) {
        return Toast({
          message: '输入内容为空或有误',
          duration: 1500
        });
      ...
      let params = {
        ...
        reqData: {
          ...
          barSize: 'S',
          mobile: this.phone,
          ownerName: this.perName,
          name: this.name,
          catag: this.item,
          addressProvince: this.tpmAddress[0],
          addressCity: this.tpmAddress[1],
          addressArea: this.tpmAddress[2],
