            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  children: [
                    {value: '东河区',label: '东河区'},
                    {value: '昆都伦区',label: '昆都伦区'},
                    {value: '青山区',label: '青山区'},
                    {value: '石拐矿区',label: '石拐矿区'},
    ...
    methods: {
      ...
      getProv() {
        ...
        for (var val of allCity){
          if (this.form.address_province === val.value){
      ...
      getCity() {
        ...
        for (var val of allArea){
          if (this.form.address_city === val.value){
            this.area=val.children;
          }
        }
      }
    },
